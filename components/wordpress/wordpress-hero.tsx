        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left">
            ...
            <div className="mb-4 inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 font-body font-semibold text-xs leading-none text-[#0A1616] bg-[#46FDAE]">
              ...
              <span>Premium Managed hosting for WordPress</span>
            </div>

            {/* Headline */}
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0A1616] tracking-tight antialiased mb-6 leading-tight">
              Now in Bangladesh! It’s time to experience managed hosting for WordPress done right - fast, secure, and effortless.
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
              <div className="flex items-center gap-2.5 text-sm font-medium text-[#0A1616]">
                ...
                <span>Enterprise CDN included standard</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm font-medium text-[#0A1616]">
                <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#114B27] text-white shrink-0">
                  <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span>Enterprise WAF & bot defense</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm font-medium text-[#0A1616]">
                <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#114B27] text-white shrink-0">
                  <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span>Unlimited free white-glove migrations</span>
              </div>
              <div className="flex items-center gap-2.5 text-sm font-medium text-[#0A1616]">
                <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#114B27] text-white shrink-0">
                  <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span>24/7/365 in-house WP engineers</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                <span className="block font-semibold text-sm sm:text-base">See WordPress Plans</span>
              ...
              >
                <span className="block font-semibold text-sm sm:text-base">Book a demo</span>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-lg">
              <Image
                src="/assets/billboard/bd-managed-wp-hosting-2.webp"
