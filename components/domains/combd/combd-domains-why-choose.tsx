...
import { Check, ArrowRight, TrendingUp, Activity, ShieldCheck } from "lucide-react";
import { Button } from "@/components/ui/button";

export function CombdDomainsWhyChoose() {
  const points = [
    "Showcase your authentic local presence",
    "Support local SEO rankings on Google Bangladesh",
    "Stimulate customer trust and loyalty",
    "Perfect for all commercial companies and startups in Bangladesh",
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0A1616] tracking-tight">
              Why choose a <br />.com.bd domain?
            </h2>

            <p className="text-base text-[#556360] leading-relaxed">
              A .com.bd domain clearly establishes who and where you are. It tells customers you&apos;re authentic, approachable, and local. If you&apos;re targeting buyers in Bangladesh, a .com.bd domain is essential.
            </p>
            ...
            <p className="text-xs sm:text-sm text-[#6D7779] pt-2">
              Ready to secure your branded domain? Search for your ideal .com.bd domain and register in minutes.
            </p>
              ...
              <div className="w-full max-w-sm rounded-2xl bg-[#0A1616]/95 border border-white/20 p-6 shadow-2xl space-y-6 text-white backdrop-blur-md">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-white tracking-wide">Bangladesh Network</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-1">
                    ...
                    <div className="text-[10px] text-[#8E9F9A]">ccTLD .com.bd</div>
                  </div>
