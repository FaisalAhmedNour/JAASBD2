...
export function ComparisonHero() {
  return (
    <section className="bg-background relative pt-12 pb-8 lg:pt-20 lg:pb-16">
      <div className="relative z-10">
        <div className="container mx-auto px-siteContainer text-center">
          {/* Pre-heading Badge */}
          ...
          {/* Heading */}
          <div className="mb-4">
            <h1 className="block hyphens-auto text-balance break-words font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0A1616] tracking-tight antialiased mx-auto max-w-4xl">
              One platform. First site to full server.
            </h1>
          </div>

          {/* Subtitle */}
          <div className="text-base sm:text-lg text-[#455A58] max-w-2xl mx-auto mb-8 leading-relaxed">
            <p>
              Start on web hosting, move to a managed server of your own when you outgrow it — same platform, same team, no re-platforming. Hosting that grows with you.
            </p>
          </div>

          {/* Action CTAs */}
          <div className="justify-center flex flex-wrap items-center gap-4">
            <Link
              href="#plans"
            ...
            >
              <span className="block font-semibold text-sm sm:text-base">See Plans</span>
            ...
            >
              <span className="block font-semibold text-sm sm:text-base">Talk to our team</span>
